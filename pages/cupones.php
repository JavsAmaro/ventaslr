...
?>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Cupones &nbsp;<a  href="#" data-toggle="modal" data-target="#cuponModal" type="button" class="btn btn-primary bg-gradient-primary" style="border-radius: 0px;"><i class="fas fa-fw fa-plus"></i></a></h4>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">        
                  ...
                  <tbody>
                    <?php                  
                      $query = "SELECT * FROM cupones WHERE /*DATE LIKE '{$manana}%' AND*/ CITY LIKE '{$_SESSION['CITY']}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
