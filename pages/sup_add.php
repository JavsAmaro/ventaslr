...
window.onload = function() {  
  ...
  console.log($.getCities("Batangas")); 
          ...
          <center><div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
            ...
            <a href="supplier.php?action=add" type="button" class="btn btn-primary bg-gradient-primary">Volver</a>
            <div class="card-body">
              <div class="table-responsive">
                        <form role="form" method="post" action="sup_transac.php?action=add">
                            
                            <div class="form-group">
                              <input class="form-control" placeholder="Nombre de Compañia" name="companyname" required>
                            </div>
                            <div class="form-group">
