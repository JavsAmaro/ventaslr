...
if ($Aa=='User'){
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Agegar Cliente</h4>
            </div>
            <a href="customer.php" type="button" class="btn btn-primary bg-gradient-primary">Volver</a>
            <div class="card-body">
                        ...
                        <form role="form" method="post" action="cust_transac.php?action=add">
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="Télefono" name="phonenumber" required>
                            </div>
                            <hr>
