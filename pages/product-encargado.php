...
<button type="B1"  class="btn--sucursales btn-primary  " style="border-radius: 0px;" onclick="myFunctionB1()">Sucursal</button>
  <button type="B2"  class="btn--sucursales btn-primary " style="border-radius: 0px;" onclick="myFunctionB2()">DIDI</button>
  <button type="B3"  class="btn--sucursales btn-primary " style="border-radius: 0px;" onclick="myFunctionB3()">UBER</button>
  <button type="B3"  class="btn--sucursales btn-primary " style="border-radius: 0px;" onclick="myFunctionB4()">Rappi</button>
</div>
<br>
...
<?php                  
   ...
   $query = "SELECT PRODUCT_ID, IMAGENES, PRODUCT_CODE, QTY_STOCK, NAME, CITY, PRICE, CNAME, DATE_STOCK_IN FROM product p join category c on p.CATEGORY_ID=c.CATEGORY_ID WHERE c.CATEGORY_ID LIKE 1 OR c.CATEGORY_ID LIKE 2 OR c.CATEGORY_ID LIKE 3 OR c.CATEGORY_ID LIKE 4 OR c.CATEGORY_ID LIKE 5 OR c.CATEGORY_ID LIKE 6 OR c.CATEGORY_ID LIKE 7 OR c.CATEGORY_ID LIKE 8 OR c.CATEGORY_ID LIKE 0 ORDER BY c.CATEGORY_ID ";
...
<?php                  
   ...
   $query = "SELECT PRODUCT_ID, IMAGENES, QTY_STOCK, PRODUCT_CODE, NAME, CITY, PRICE, CNAME, DATE_STOCK_IN FROM product p join category c on p.CATEGORY_ID=c.CATEGORY_ID WHERE c.CATEGORY_ID LIKE 10 OR c.CATEGORY_ID LIKE 11 OR c.CATEGORY_ID LIKE 12 OR c.CATEGORY_ID LIKE 13 OR c.CATEGORY_ID LIKE 14 OR c.CATEGORY_ID LIKE 15 OR c.CATEGORY_ID LIKE 16 OR c.CATEGORY_ID LIKE 17 OR c.CATEGORY_ID LIKE 18 ORDER BY c.CATEGORY_ID ";
...
<?php                  
   ...
   $query = "SELECT PRODUCT_ID, IMAGENES,QTY_STOCK, PRODUCT_CODE, NAME, CITY, PRICE, CNAME, DATE_STOCK_IN FROM product p join category c on p.CATEGORY_ID=c.CATEGORY_ID WHERE c.CATEGORY_ID LIKE 40 OR c.CATEGORY_ID LIKE 41 OR c.CATEGORY_ID LIKE 42 OR c.CATEGORY_ID LIKE 44 OR c.CATEGORY_ID LIKE 44 OR c.CATEGORY_ID LIKE 45 OR c.CATEGORY_ID LIKE 46 OR c.CATEGORY_ID LIKE 47 OR c.CATEGORY_ID LIKE 48
