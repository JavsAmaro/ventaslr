                      ...
                      echo '<td align="right"> <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                <li>
                                  ...
                                  <li>
                                  <a type="button" class="btn btn-danger bg-gradient-danger btn-block" style="border-radius: 0px;" href="sup_del.php?action=edit & id='.$row['SUPPLIER_ID']. '">
                                    <i class="fas fa-fw fa-edit"></i> Edit
                                  </a>
                                </li> 
        ...
        <div class="modal-body">
          <form role="form" method="post" action="sup_transac.php?action=add">
              ...
              <div class="form-group">
                <input class="form-control" placeholder="nombre de empresa" name="companyname" required>
              </div>
              <div class="form-group">
