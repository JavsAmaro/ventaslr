     ...
     <div class="col-5" style="margin: auto;">   
              ...
              <input type="hidden" name="id" value="<?php echo $zz; ?>" />
               <div class="form-group row text-left text-warning">
                ...
                <div class="col-6">
                  <input class="form-control" placeholder=" Nombre del Cliente" name="numofitems" value="<?php echo $nombre; ?> <?php echo $apellido; ?>" readonly="readonly">
                </div>
              </div>
             <div class="form-group row text-left text-warning">
                <div class="col-6" style="padding-top: 5px;">
                ...
                <div class="col-6">
                  <input class="form-control" placeholder=" Nombre del Cliente" name="numofitems" value="<?php echo $telefono; ?>" readonly="readonly">
                </div>
              </div>
              ...
              <div class="form-group row text-left text-warning">
                ...
                <div class="col-6">
                  <input class="form-control" placeholder=" Numero de Items:" name="numofitems" value="<?php echo $i; ?>" readonly="readonly">
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-6" style="padding-top: 5px;">
                ...
                <div class="col-6">
                  <input class="form-control" placeholder="Total" name="grandtotal" value="<?php echo $a; ?>" readonly="readonly">
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-6" style="padding-top: 5px;">
                ...
                <div class="col-6">
                   <input class="form-control" placeholder="Efectivo" name="cash" value="<?php echo $b; ?>" readonly="readonly">
                </div>
              </div>
