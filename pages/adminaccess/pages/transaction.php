...
#date::placeholder,#date2::placeholder { /* Chrome, Firefox, Opera, Safari 10.1+ */
  color: #fff;
  opacity: 1; /* Firefox */
}
...
<?php
                    $query = "SELECT * FROM transaction WHERE date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%'";
...
<?php     
      $query = "SELECT * FROM transaction WHERE METODO_PAGO LIKE '{$efectivo}%' AND date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%' ";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php    
       $query = "SELECT * FROM transaction WHERE date(DATE)  LIKE '{$today}%' AND METODO_PAGO LIKE '{$tarjeta}%' AND CITY LIKE '{$location}%'";
        $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<!-------    Formas de Pago     --------->
<?php     
      $query = "SELECT * FROM transaction WHERE  METODO_PAGO LIKE '{$efectivo}%' AND INTERMEDIARIO LIKE'{$uber}%' AND date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
?>
<?php     
      $query = "SELECT * FROM transaction WHERE  METODO_PAGO LIKE '{$tarjeta}%' AND INTERMEDIARIO LIKE'{$uber}%' AND date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php     
      $query = "SELECT * FROM transaction WHERE  METODO_PAGO LIKE '{$efectivo}%' AND INTERMEDIARIO LIKE'{$sindelantal}%' AND date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php     
      $query = "SELECT * FROM transaction WHERE METODO_PAGO LIKE '{$tarjeta}%' AND INTERMEDIARIO LIKE'{$sindelantal}%'  AND date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php     
      $query = "SELECT * FROM transaction WHERE  METODO_PAGO LIKE '{$efectivo}%' AND INTERMEDIARIO LIKE'{$didi}%'  AND date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php     
      $query = "SELECT * FROM transaction WHERE  METODO_PAGO LIKE '{$tarjeta}%' AND INTERMEDIARIO LIKE'{$didi}%'  AND date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php     
      $query = "SELECT * FROM transaction WHERE METODO_PAGO LIKE '{$efectivo}%' AND INTERMEDIARIO LIKE'{$rappi}%'  AND date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php     
      $query = "SELECT * FROM transaction WHERE METODO_PAGO LIKE '{$tarjeta}%' AND INTERMEDIARIO LIKE'{$rappi}%'  AND date(DATE)  LIKE '{$today}%' AND CITY LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
//       $query = "SELECT * FROM cortes WHERE date(DATE)  LIKE '{$today}%'";
       ...
       $query = "SELECT * FROM cortes WHERE date(DATE)  LIKE '{$manana}%' AND CITY  LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
//       $query = "SELECT * FROM cortes WHERE date(DATE)  LIKE '{$today}%'";
       ...
       $query = "SELECT * FROM cortes WHERE date(DATE)  LIKE '{$today}%' AND CITY  LIKE '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
if (floor ($semanas) >= 0) {
                      ...
                      $query = "SELECT * FROM transaction WHERE date(DATE)  >= '{$primerLunes}%' AND date(DATE) <= '{$primerDomingo}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php   
            if (floor ($semanas) >= 0){
                      ...
                      $query = "SELECT * FROM cortes WHERE date(DATE)  >= '{$primerLunes}%' AND date(DATE) <= '{$primerDomingo}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
                  ...
                  //  el monto se le resta al total de las ventas dejando solo el monto 
                    ...
                    $query2 = "SELECT PROVEEDOR, DESCRIPCION, SUM(MONTO) as MONTO_CAJA FROM cortes
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$primerLunes}%' AND '{$primerDomingo}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE '{$location}%' GROUP BY supplier.COMPANY_NAME";
...
<?php 
      ...
      if (floor ($semanas) >= 1){
                      ...
                      $query = "SELECT * FROM transaction WHERE date(DATE)  >= '{$segundoLunes}%' AND date(DATE) <= '{$segundoDomingo}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php    
            if (floor ($semanas) >= 1){
                      ...
                      $query = "SELECT * FROM cortes WHERE date(DATE)  >= '{$segundoLunes}%' AND date(DATE) <= '{$segundoDomingo}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
                  ...
                  //  el monto se le resta al total de las ventas dejando solo el monto 
                      ...
                      $query2 = "SELECT PROVEEDOR, DESCRIPCION, SUM(MONTO) as MONTO_CAJA FROM cortes
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$segundoLunes}%' AND '{$segundoDomingo}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE '{$location}%' GROUP BY supplier.COMPANY_NAME";
                      $result2 = mysqli_query($db, $query2) or die (mysqli_error($db));
...
<?php       //Seccion semana3  
              if (floor ($semanas) >= 2){
                      ...
                      $query = "SELECT * FROM transaction WHERE date(DATE)  >= '{$tercerLunes}%' AND date(DATE) <= '{$tercerDomingo}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php          if (floor ($semanas) >= 2){
                      ...
                      $query = "SELECT * FROM cortes WHERE date(DATE)  >= '{$tercerLunes}%' AND date(DATE) <= '{$tercerDomingo}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
                  ...
                  //  el monto se le resta al total de las ventas dejando solo el monto 
                      ...
                      $query2 = "SELECT PROVEEDOR, DESCRIPCION, SUM(MONTO) as MONTO_CAJA FROM cortes
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$tercerLunes}%' AND '{$tercerDomingo}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE '{$location}%' GROUP BY supplier.COMPANY_NAME";
                      $result2 = mysqli_query($db, $query2) or die (mysqli_error($db));
        
                      while ($row = mysqli_fetch_assoc($result2)) {
                      $gastosSemana3 +=  $row['MONTO_CAJA'];
...
if (floor ($semanas) >= 3){
                      ...
                      $query = "SELECT * FROM transaction WHERE date(DATE)  >= '{$cuartoLunes}%' AND date(DATE) <= '{$cuartoDomingo}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
if (floor ($semanas) >= 3){
                      ...
                      $query = "SELECT * FROM cortes WHERE date(DATE)  >= '{$cuartoLunes}%' AND date(DATE) <= '{$cuartoDomingo}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
                  ...
                  //  el monto se le resta al total de las ventas dejando solo el monto 
                      ...
                      $query2 = "SELECT PROVEEDOR, DESCRIPCION, SUM(MONTO) as MONTO_CAJA FROM cortes
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$cuartoLunes}%' AND '{$cuartoDomingo}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE '{$location}%' GROUP BY supplier.COMPANY_NAME";
                      $result2 = mysqli_query($db, $query2) or die (mysqli_error($db));
        
                      while ($row = mysqli_fetch_assoc($result2)) {
                      $gastosSemana4 +=  $row['MONTO_CAJA'];
...
if (floor ($semanas) >= 4){
                      ...
                      $query = "SELECT * FROM transaction WHERE date(DATE)  >= '{$quintoLunes}%' AND date(DATE) <= '{$lastDay}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
if (floor ($semanas) >= 4){
                      ...
                      $query = "SELECT * FROM cortes WHERE date(DATE)  >= '{$quintoLunes}%' AND date(DATE) <= '{$lastDay}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
                  ...
                  //  el monto se le resta al total de las ventas dejando solo el monto 
                      ...
                      $query2 = "SELECT PROVEEDOR, DESCRIPCION, SUM(MONTO) as MONTO_CAJA FROM cortes
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$quintoLunes}%' AND '{$lastDay}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE '{$location}%' GROUP BY supplier.COMPANY_NAME";
                      $result2 = mysqli_query($db, $query2) or die (mysqli_error($db));
        
                      while ($row = mysqli_fetch_assoc($result2)) {
                      $gastosSemana5 +=  $row['MONTO_CAJA'];
...
<?php                  
                      $query = "SELECT * FROM transaction WHERE date(DATE)  >= '{$firstDay}%' AND date(DATE) <= '{$lastDay}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered display" width="100%" cellspacing="0">        
                  ...
                  <tbody>
                                       <?php                  
                      $query = "SELECT * FROM cortes WHERE DATE LIKE '{$today}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered display" width="100%" cellspacing="0">        
                  ...
                  <tbody>
                    <?php                  
                      $query = "SELECT * FROM cortes WHERE date(DATE) BETWEEN '{$lunes}%' AND '{$domingo}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered display" width="100%" cellspacing="0">        
                  ...
                  <tbody>
                    <?php                  
                      $query = "SELECT * FROM cortes WHERE date(DATE)  > '{$firstDay}%' AND DATE <= '{$today}%' AND CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
             ...
             <form action="" method="POST">
              ...
              <div class="row" style="justify-content: center;">
                <b style=" align-self: center;font-size: x-large;padding: 0px 10px;"> DEL </b>

                <input class="date" style="width: 20%;" type="text" id="date" name="date" placeholder="Fecha Inicio <?php echo date("d-m-Y", strtotime($firstDay) ); ?>" autocomplete="off" required >
                <b style=" align-self: center;font-size: x-large;padding: 0px 10px;"> AL </b>
                <input class="date2" style="width: 20%;"  type="text" id="date2" name="date2" placeholder="Fecha Final <?php echo date("d-m-Y", strtotime($lastDay) ); ?>" autocomplete="off" required >
                <b style=" align-self: center;font-size: x-large;padding: 0px 10px;"> EN </b>
        <?php
                  echo $opt;
                ?>
                <input type="submit"  style="background-color: #500D76;color: #FFF;font-size:20px;text-align: center;margin: : 0px 10px;" name="submit" value="Buscar">
...
if (floor ($semanas) > 4){
             ...
             <?php  } ?>   
                   ...
                   <tr style="background-color: #FFCC01; color: #fff" >
                     <td >Sub Total</td>
                     <td style="color: red;">$<?php echo number_format( $utilidadMes, 2, '.', ','); ?></td>
                     <td >$<?php echo number_format( $ventaMes, 2, '.', ','); ?></td>
                     <td >$<?php echo number_format( $gastoMes, 2, '.', ','); ?></td>
                  </tr> 
   ...
   <tr>
                  ...
                  <tr>
                    ...
                    <?php                  
                     ...
                     WHERE date(DATE) BETWEEN '{$firstDay}%' AND '{$lastDay}%' AND TIPO LIKE '3' AND  CITY LIKE '{$location}%'";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
 ...
 <tr>
                  ...
                  <tr>
                    ...
                    <?php                  
                      ...
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$firstDay}%' AND '{$lastDay}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE '{$location}%' GROUP BY supplier.COMPANY_NAME";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
 ...
 <tr>
                  ...
                  <tr>
                    ...
                    <?php                  
                      ...
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$firstDay}%' AND '{$lastDay}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '2' AND cortes.CITY  LIKE '{$location}%' GROUP BY supplier.COMPANY_NAME";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
                 ...
                 <tr style="background-color: #FFCC01; color: #000;">
                     ...
                     <td >$<?php echo number_format( $ventaMes, 2, '.', ','); ?></td>
                     <td >$<?php echo number_format( $gastoFinal, 2, '.', ','); ?></td>
                  </tr> 
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Productos vendidos &nbsp;</h4>
            </div>
                ...
                <table class="table table-bordered display" width="100%" cellspacing="0">        
                  ...
                  <tbody>
                    ...
                    INNER JOIN transaction t2
                            ON t1.TRANS_D_ID = t2.TRANS_D_ID WHERE t2.CITY LIKE '{$location}%' AND date(t2.DATE) BETWEEN '{$firstDay}%' AND '{$lastDay}%'
                     GROUP BY p.NAME";*/
...
<?php                  
    $query = "SELECT *, FIRST_NAME, LAST_NAME, PHONE_NUMBER
              FROM transaction T
              JOIN customer C ON T.`CUST_ID`=C.`CUST_ID` AND T.CITY LIKE '{$location}%' AND date(T.DATE) BETWEEN '{$firstDay}%' AND '{$lastDay}%'
