   ...
   $query = "SELECT * FROM blog ORDER BY FECHA_PUBLICACION DESC ";
        ...
        $result = mysqli_query($db, $query) or die (mysqli_error($db));
            ...
            while ($row = mysqli_fetch_assoc($result)) {
               ...
               if( $row['PORTADA'] == null)
                           {
                             echo '<img src="/ventas/pages/img/lr-logo.jpg" alt="" style="width: 100px;height: 100px;" />';

                           }if($row['PORTADA'] != null)
                           {
                             echo '<img src="/ventas/pages/img/'.$row['PORTADA'].'" alt="" style="width: 100px;height: 100px;" />';
                           }
               echo '</td">';
