...
?>
     ...
     <div class="col-5" style="margin: auto;">  
          ...
          <div class="row">
            <div class="col-6">
              <div id="admin">
                  <a href="pedidos.php" type="button" class="btn btn-primary bg-gradient-primary btn-block"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Volver </a>
              </div>
              <div id="encargado">
                  <a href="transaction-encargado.php" type="button" class="btn btn-primary bg-gradient-primary btn-block"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Volver </a>
              </div>
            </div>
       <div class="col-6" >
        <!--
