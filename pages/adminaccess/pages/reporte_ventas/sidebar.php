...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!--
      <li class="nav-item">
        <a class="nav-link" href="inventory.php" style="display: -webkit-inline-box;">
      ...
      <!--
      <li class="nav-item">
        <a class="nav-link" href="supplier.php" style="display: -webkit-inline-box;">
...
if ($_SESSION['TYPE'] == 'Admin'){
             ?>    <script type="text/javascript">
                   document.getElementById('accordionSidebar').style.display = 'block';
                    document.getElementById('accordionSidebar_encargado').style.display = 'none';
                  </script>
             <?php   } if ($_SESSION['TYPE'] == 'Encargado'){?>
                  <script type="text/javascript">
                  document.getElementById('accordionSidebar_encargado').style.display = 'block';
