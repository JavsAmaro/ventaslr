...
<?php          if (floor ($semanas) >= 2){
                  ...
                  //  el monto se le resta al total de las ventas dejando solo el monto 
                      ...
                      $query2 = "SELECT PROVEEDOR, DESCRIPCION, SUM(MONTO) as MONTO_CAJA FROM cortes
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$tercerLunes}%' AND '{$tercerDomingo}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE '{$_SESSION['CITY']}%' GROUP BY supplier.COMPANY_NAME";
                      $result2 = mysqli_query($db, $query2) or die (mysqli_error($db));
...
if (floor ($semanas) >= 3){
                  ...
                  //  el monto se le resta al total de las ventas dejando solo el monto 
                      ...
                      $query2 = "SELECT PROVEEDOR, DESCRIPCION, SUM(MONTO) as MONTO_CAJA FROM cortes
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$cuartoLunes}%' AND '{$cuartoDomingo}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE '{$_SESSION['CITY']}%' GROUP BY supplier.COMPANY_NAME";
                      $result2 = mysqli_query($db, $query2) or die (mysqli_error($db));
...
if (floor ($semanas) >= 4){
                  ...
                  //  el monto se le resta al total de las ventas dejando solo el monto 
                      ...
                      $query2 = "SELECT PROVEEDOR, DESCRIPCION, SUM(MONTO) as MONTO_CAJA FROM cortes
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) BETWEEN '{$quintoLunes}%' AND '{$lastDay}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE '{$_SESSION['CITY']}%' GROUP BY supplier.COMPANY_NAME";
                      $result2 = mysqli_query($db, $query2) or die (mysqli_error($db));
              ...
              $( "#date2" ).datepicker({
                  ...
                  <tr>
                    ...
                    <tr  id="semana1" style="display: none">
                     ...
                     <td >$ <?php echo $utilidadSemana1; ?></td>
                     <td >$ <?php echo $ventaSemana1; ?></td>
                     <td >$ <?php echo $gastosSemana1; ?></td>
                  </tr> 
                   <tr  id="semana2" style="display: none">
                     ...
                     <td >$ <?php echo $utilidadSemana2; ?></td>
                     <td >$ <?php echo $ventaSemana2; ?></td>
                     <td >$ <?php echo $gastosSemana2; ?></td>
                  </tr> 
                   ...
                   <tr  id="semana3" style="display: none">
                     ...
                     <td >$ <?php echo $utilidadSemana3; ?></td>
                     <td >$ <?php echo $ventaSemana3; ?></td>
                     <td >$ <?php echo $gastosSemana3; ?></td>
                  </tr> 
                   ...
                   <tr  id="semana4" style="display: none">
                     ...
                     <td >$ <?php echo $utilidadSemana4; ?></td>
                     <td >$ <?php echo $ventaSemana4; ?></td>
                     <td >$ <?php echo $gastosSemana4; ?></td>
                  </tr> 
                 ...
                 <tr id="semana5" style="display: none">
                     <td style="background-color: #500D76; color: #fff;">Semana 5  (<?php echo date("d-m-Y", strtotime($quintoLunes) ); ?> / <?php echo date("d-m-Y", strtotime($quintoDomingo) ); ?>)</td>
                      <td >$ <?php echo $utilidadSemana5; ?></td>
                     <td >$ <?php echo $ventaSemana5; ?></td>
                     <td >$ <?php echo $gastosSemana5; ?></td>
                  </tr>
...
if (floor ($semanas) > 4){
             ...
             <?php  } ?>   
                   ...
                   <tr style="background-color: #FFCC01; color: #fff" >
                     <td >Sub Total</td>
                     <td style="color: red;">$<?php echo $utilidadMes; ?></td>
                     <td >$<?php echo $ventaMes; ?></td>
                     <td >$<?php echo $gastoMes; ?></td>
                  </tr> 
...
<?php                  
    $query = "SELECT *, FIRST_NAME, LAST_NAME, PHONE_NUMBER
              FROM transaction T
              JOIN customer C ON T.`CUST_ID`=C.`CUST_ID` AND T.CITY LIKE '{$_SESSION['CITY']}%' AND date(T.DATE) BETWEEN '{$firstDay}%' AND '{$lastDay}%'
