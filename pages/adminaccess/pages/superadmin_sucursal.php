...
<?php
    ...
    $query = "SELECT * FROM transaction WHERE date(DATE) BETWEEN '{$Ulunes}%' AND '{$Pdomingo}%' AND CITY  LIKE  '{$location}%'";
...
<!-------    Formas de Pago     --------->
<?php     
      $query = "SELECT * FROM transaction WHERE METODO_PAGO LIKE '{$efectivo}%' AND INTERMEDIARIO LIKE'{$efectivo}%' AND date(DATE)  LIKE '{$today}%' AND CITY  LIKE  '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
?>
<?php    
       $query = "SELECT * FROM transaction WHERE METODO_PAGO LIKE '{$tarjeta}%'  AND INTERMEDIARIO LIKE'{$efectivo}%' AND date(DATE)  LIKE '{$today}%' AND CITY  LIKE  '{$location}%'";
        $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
//       $query = "SELECT * FROM cortes WHERE FECHA  LIKE '{$today}%'";
       ...
       $query = "SELECT * FROM cortes WHERE DATE  LIKE '{$manana}%' AND CITY  LIKE  '{$location}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
     ...
     ?>
                    ...
                    <?php                  
                      ...
                      INNER JOIN supplier WHERE supplier.COMPANY_NAME = cortes.PROVEEDOR AND date(DATE) LIKE '{$today}%' AND TIPO LIKE '2' AND supplier.TYPE LIKE '1' AND  cortes.CITY  LIKE  '{$location}%' GROUP BY supplier.COMPANY_NAME";
                      $result = mysqli_query($db, $query) or die (mysqli_error($db));
         ...
         <div class="col-3 mb-3">
           ...
           <div class="col-3 mb-3">
            ...
            <div class="card shadow mb-12">
              <div class="row">
            <div class=" py-12 col-sm-12 col-md-4">
              <h4 class="m-2 font-weight-bold text-primary">Resumen del día<br> <?php echo $location ;  ?></h4>
            </div>



            <div class="py-12 col-sm-12 col-md-8" style="margin: auto;">
