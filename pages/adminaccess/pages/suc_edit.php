...
?>
  ...
  <center><div class="card shadow col-xs-12 col-md-12 border-bottom-primary">
            ...
            <form role="form" method="post" action="blog_edit1.php"  enctype="multipart/form-data">
...
<img src="img/<?php echo $imageURL; ?>" alt="" style="width: 60%;" />
            ...
            <div class="col-12">
              ...
              <div class="form-group row text-left text-warning">
                <div class="col-sm-12" style="padding-top: 5px;">
                 Descripción:<br>                
                   <textarea class="form-control" placeholder="descripcion" name="descripcion"><?php echo $descripcion; ?></textarea>
                </div>
              </div>
              <div class="form-group row text-left text-warning">
                <div class="col-sm-12">
               ...
               <div class="form-group row text-left text-warning">
                <div class="col-sm-12">
                  Link del newsletter:<br>

                  <input class="form-control" placeholder="link" name="link" value="<?php echo $link; ?>" required>
                </div>
              </div>
