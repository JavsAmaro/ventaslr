<!-- Aqui se encuentras todos los formularios desplegables  -->
...
// este es un input select que manda a traer todos las vacantes de la base de datos 
...
<?php
// este es un input select que manda a traer todas las SUCURSALES de la base de datos 
...
// este es un input select que manda a traer todos los PROVEEDORES MENSUALES de la base de datos 
...
// este es un input select que manda a traer todos los PROVEEDORES DE CAJA de la base de datos 
...
// este es un input select que manda a traer todos los PRODUCTOS de la base de datos para editar el inventario 
...
?>
  ...
  <div class="modal fade" id="corteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="form-group">
            ...
            <select class='form-control' name='tipo' required on>
...
<!-- A;adir pago a provedor en CAJA -->
        ...
        <div class="modal-body">
          <form role="form" method="post" action="inventario_transac2.php?action=add">
            ...
            <div class="form-group">
              ...
              <input class="form-control" type="hidden" placeholder="Fecha" name="fecha" value="<?php echo $today = date("Y-m-d H:i:s"); ?>" required>
  ...
  <div class="modal fade" id="corteExtraModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      ...
      <input type="date" id="fecha" name="fecha" value="<?php echo $today ?>">
              ...
              //Escrypt para acomodar el data picker(fecha) al formulario 
 ...
 <!-- agregar sucursal Sucursal Modal-->
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="suc_transac.php?action=add">
            <div class="form-group">
              <input class="form-control" placeholder="Sucursal" name="sucursal" required>
            </div>
