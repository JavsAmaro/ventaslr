...
<body id="page-top">
  ...
  <div id="wrapper" style="display: contents;">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  style="text-decoration: none; font-size: 18px; font-weight: bold;" href="admin_sucursal.php">
