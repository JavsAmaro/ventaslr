    ...
    {   
      ...
      ?>
            ...
            <div class="card-header py-3">
              ...
              <a type="button" class="btn btn-primary bg-gradient-primary" href="reimp.php?action=edit&id=<?php echo $id ?>"><i class="fas fa-fw fa-list-alt"></i> Reimprimir</a>
...
?>
 ...
 <a onclick="goBack()" style="color: #fff;" type="button" class="btn btn-primary bg-gradient-primary btn-block"> <i class="fas fa-flip-horizontal fa-fw fa-share"></i> Volver </a>
  ...
  if ($row['TYPE']=='Encargado'){
    echo ' <a  href="#" data-toggle="modal"  id="myTextField"  value="Truck" data-target="#aModal" type="button" class="btn btn-danger bg-gradient-danger btn-block" > <i class="fas fa-fw fa-ban"></i>Cancelar</a>';
  }
}
?>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Motivo Cancelación</h5>
