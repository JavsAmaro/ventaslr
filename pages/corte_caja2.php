...
//            $today = date("j-n-Y"); 
            $ayer =date('j-n-Y',strtotime("-1 days"));//////dia anterior
            
            $manana =date('j-n-Y',strtotime("+1 days"));//////dia anterior
...
$caja=($ingreso+$PagoEfectivo+$Totalcaja)-$salidaEfectivo;
$totalcorte=$caja-$Totalcaja;


   ?>

<?php /*Iserte fondo del dia siguiente    
      $query = "SELECT * FROM transaction WHERE METODO_PAGO LIKE '{$tarjeta}%' AND INTERMEDIARIO LIKE'{$rappi}%'  AND DATE  LIKE '{$today}%'";
       $result = mysqli_query($db, $query) or die (mysqli_error($db));
...
<?php  /*   
      ...
      "INSERT INTO transaction (TIPO, MONTO, DATE) VALUES ('Test', 'Testing', 'Testing@tesing.com')"
...
<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
          ...
          <!--           <div class="col-2">
                    ...
                    <?php
                        echo "Fecha de hoy: <br>$today";
                        ?>

              <label for="start">Seleccionar dia:</label>
<input type="date" id="start" name="trip-start"
       value="<?php $today?>">

<form  method="POST">
      <input type="date" class="form-control" id="fecha1" name="fecha1" placeholder="<?php echo $today;?>">
       <input type="hidden" class="form-control" id="fecha2" placeholder="dd/mm/aaaa">
...
<form action="" method="POST">
  <input type="text" id="date" name="date" placeholder="Fecha hoy <?php  echo "$today"; ?>" >
  <input type="submit" name="submit" value="Fecha">
</form>
...
$( "#date" ).datepicker({
    ...
    onSelect  : function() {
        ...
        console.log( $('#alternate').val() );
              ...
              <span class="m-2 font-weight-bold ">Fondo Inicial &nbsp; $<?php echo $ingreso; ?>  </span><br>
              ...
              <span class="m-2 font-weight-bold ">Pagos Con Tarjeta &nbsp; $<?php echo $PagoTarjeta; ?>
               ...
               <span class="m-2 font-weight-bold ">Corte&nbsp;$<?php echo $Totalcaja; ?>
              </span><br>
         </div>
</div></div>
...
<a href="#" data-toggle="modal" data-target="#corteCajaModal" type="button" class="btn btn-danger bg-gradient-danger" style="border-radius: 0px;"><i >Cerrar Caja</i></a>
            ...
            <div class="card-header py-12 col-sm-3 col-md-2">
<a href="#" data-toggle="modal" data-target="#corteModal" type="button" class="btn btn-danger bg-gradient-danger" style="border-radius: 0px;"><i> Imprimir</i></a>            </div>
