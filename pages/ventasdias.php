...
$fondoInicial=$corte+$fondo;
      ...
      ?>
            ...
            <div class="card-header py-3">
              <h4 class="m-2 font-weight-bold text-primary">Ventas Hoy&nbsp;</h4>
            </div>
              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">        
                  ...
                  <tbody>
                    ...
                    $query = "SELECT * FROM transaction INNER JOIN customer WHERE transaction.CUST_ID = customer.CUST_ID AND transaction.DATE LIKE '{$today}%' AND transaction.CITY LIKE '{$_SESSION['CITY']}%'";
                       $result = mysqli_query($db, $query) or die (mysqli_error($db));
