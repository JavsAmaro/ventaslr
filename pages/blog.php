...
<div class="card shadow mb-4" id="sucursal">
            ...
            <div class="card-body">
              <div class="table-responsive">
                 <h4 class="m-2 font-weight-bold text-primary">Blog </h4>
                      ...
                      echo '<td align="right " style="width:15%"> <div class="btn-group">
                            ...
                            <ul class="dropdown-menu text-center" role="menu">
                                <li>
                                  ...
                                  <a type="button" class="btn btn-warning bg-gradient-warning btn-block" style="border-radius: 0px;width: 220px;" href="'.$row['LINK']. '">
                                    <i class="fas fa-external-link-alt"></i> Ir al Contenido
                                  </a>
